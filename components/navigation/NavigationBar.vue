...
import ModalDetailSpeciesSelected from '~/components/modals/ModalDetailSpeciesSelected'

export default {
  name: "NavigationBar",
  components: {ModalDetailSpeciesSelected},
   computed: {
    ...mapGetters({
      totalSpeciesSelected: 'getTotalSpeciesSelected',
    })
  }
}
</script>